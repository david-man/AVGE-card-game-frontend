...
export const CARD_CATALOG: CardCatalogEntry[] = [
    ...
    { id: 'DanielYang', label: 'Daniel Yang', category: 'character', cardType: 'percussion', iconFallback: 'DAN' },
    ...
    { id: 'JuliaCiacerelli', label: 'Julia Ciacerelli', category: 'character', cardType: 'strings', iconFallback: 'JUL' },
    ...
    { id: 'MikuOtomatone', label: 'Miku Otomatone', category: 'item', iconFallback: 'MIK' },
    { id: 'Otomatone', label: 'Otomatone', category: 'item', iconFallback: 'OTO' },
